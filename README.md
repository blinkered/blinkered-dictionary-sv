# Blinkered dictionary: Swedish

The Swedish word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Swedish.

**162,041 of 371,287 candidates proved — 43.6%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Swedish, and why those
...
Candidates come from Blinkered's Swedish list, which lives in
[`blinkered-attestation/candidates/sv`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/sv).
...
| **The words we could not prove** | `LGPL-3.0` | `dropped.tsv` — **not ours to license** |
...
file a subset of that dictionary and it carries that dictionary's terms — here `LGPL-3.0`.
